...
public class Main4 {
	public static void main(String[] args) {
		...
		String[] splitF = friday.split("금요일");
		System.out.println("금요일은 " + (splitF.length - 1) + "회 나왔습니다");
		
		String[] splitW = friday.split("시계");
		System.out.println("시계는  " + (splitW.length - 1) + "회 나왔습니다");
